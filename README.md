...
<p align="center">
  <img src="https://img.shields.io/badge/Version-2.0.0-0B4F39.svg" alt="Version 2.0.0" />
...
### macOS
1. Download **`Jadwal-v2.0.0-macos-x64.zip`** from [Releases](https://github.com/mustafarajkotwala12-cmyk/Jadwal/releases).
...
### Windows
1. Download **`Jadwal-v2.0.0-windows-x64.zip`** from [Releases](https://github.com/mustafarajkotwala12-cmyk/Jadwal/releases).
